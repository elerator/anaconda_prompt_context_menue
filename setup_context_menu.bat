...
REG ADD HKCR\Directory\Background\shell\Anaconda\command /f /ve /t REG_EXPAND_SZ /d "%windir%\System32\cmd.exe /K %%USERPROFILE%%\\Anaconda3\Scripts\activate.bat"
...
REG ADD HKCR\Directory\shell\Anaconda\command /f /ve /t REG_EXPAND_SZ /d "%windir%\System32\cmd.exe /K %%USERPROFILE%%\\Anaconda3\Scripts\activate.bat"